...
namespace VxSortResearch.Unstable.AVX2.Sad
{
    ...
    public static class DoublePumpOverlinedBranchless
    {
            ...
            internal int* VectorizedPartitionInPlace(int* left, int* right, long hint)
            {
                ...
                *right = int.MaxValue;
                ...
                while (readRight >= readLeft) {
                    ...
                    // When right write-read head distance is < 8 elements
                    ...
                    var current = LoadAlignedVector256((int *) (readLeftMaybe + readRightMaybe));
