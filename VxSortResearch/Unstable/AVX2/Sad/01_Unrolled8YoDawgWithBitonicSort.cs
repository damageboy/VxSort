...
namespace VxSortResearch.Unstable.AVX2.Sad
{
    ...
    public static class DoublePumpOverlinedUnroll8YoDawgBitonicSort
    {
...
#pragma warning restore 649
            ...
            static ulong _pdepMask;
            static ulong _popCountMirror;

            static VxSortInt32()
            {
                _pdepMask       = 0x3C_3C_3C_3C_3C_3C_3C_3CUL;
                _popCountMirror = 0x20_20_20_20_20_20_20_20UL;
            ...
            internal int* Partition8VectorsInPlace(int* left, int* right, long hint)
            {
                ...
                *right = int.MaxValue;
                ...
                while (readLeft < readRight) {
                    ...
                    var nextWriteRight = writeRight - totalRight;
                    ...
                    //popCounts = ShiftLeftLogical(popCounts, 2);
                    ...
                    Store(writeLeft, L4);
                    writeLeft = (int*) ((byte*) writeLeft + ((leftCounts >> 32) & 0xFF));
                    Store(writeLeft, L5);
                    writeLeft = (int*) ((byte*) writeLeft + ((leftCounts >> 40) & 0xFF));
                    Store(writeLeft, L6);
                    writeLeft = (int*) ((byte*) writeLeft + ((leftCounts >> 48) & 0xFF));
                    Store(writeLeft, L7);
                    writeLeft = (int*) ((byte*) writeLeft + ((leftCounts >> 56) & 0xFF));
                    Store(writeRight, L0);
                    ...
                    Store(writeRight, L3);
                    writeRight = (int*) ((byte*) writeRight - ((rightCounts >> 24) & 0xFF));
                    Store(writeRight, L4);
                    writeRight = (int*) ((byte*) writeRight - ((rightCounts >> 32) & 0xFF));
                    Store(writeRight, L5);
                    writeRight = (int*) ((byte*) writeRight - ((rightCounts >> 40) & 0xFF));
                    Store(writeRight, L6);
                    writeRight = (int*) ((byte*) writeRight - ((rightCounts >> 48) & 0xFF));
                    Store(writeRight, L7);
