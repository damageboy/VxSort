...
namespace VxSortResearch.Unstable.AVX2.Happy
{
    ...
    public static class DoublePumpOverlinedPackedUnroll8BitonicSort
    {
...
#pragma warning restore 649
            ...
            internal int* Partition8VectorsInPlace(int* left, int* right, long hint)
            {
                ...
                *right = int.MaxValue;
                ...
                var pBase = BytePermTables.BytePermTableWithMinusRightPopCountAlignedPtr;
                tmpRight -= N;
...
#if HELL_FROZE
            [MethodImpl(MethodImplOptions.AggressiveInlining|MethodImplOptions.AggressiveOptimization)]
            static void PartitionBlock4VM1(Vector256<int> P,  Vector256<int> L0, Vector256<int> L1, Vector256<int> L2,
                Vector256<int>                          L3, int*          pBase,
                ref int*                                writeLeft,
                ref int*                                writeRight)
            {
                PartitionBlock1VM1(L0, P, pBase, ref writeLeft, ref writeRight);
                PartitionBlock1VM1(L1, P, pBase, ref writeLeft, ref writeRight);
                PartitionBlock1VM1(L2, P, pBase, ref writeLeft, ref writeRight);
                PartitionBlock1VM1(L3, P, pBase, ref writeLeft, ref writeRight);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining|MethodImplOptions.AggressiveOptimization)]
            static void PartitionBlock4VM2(Vector256<int> P,  Vector256<int> L0, Vector256<int> L1, Vector256<int> L2,
                Vector256<int>                            L3, int*           pBase,
                ref int*                                  writeLeft,
                ref int*                                  writeRight)
            {
                PartitionBlock1VM2(L0, P, pBase, ref writeLeft, ref writeRight);
                PartitionBlock1VM2(L1, P, pBase, ref writeLeft, ref writeRight);
                PartitionBlock1VM2(L2, P, pBase, ref writeLeft, ref writeRight);
                PartitionBlock1VM2(L3, P, pBase, ref writeLeft, ref writeRight);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining|MethodImplOptions.AggressiveOptimization)]
            static void PartitionBlock1VM1(Vector256<int> L0, Vector256<int> P, int* pBase, ref int* writeLeft, ref int* writeRight)
            {
                ...
                pc         = (8 << 2) - pc;
                writeLeft  = (int*) ((byte*) writeLeft + pc);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining|MethodImplOptions.AggressiveOptimization)]
            static void PartitionBlock1VM2(Vector256<int> L0, Vector256<int> P, int* pBase, ref int* writeLeft, ref int* writeRight)
            {
                var m0 = (ulong) (uint) MoveMask(CompareGreaterThan(L0, P).AsSingle());
                var perm = GetIntPermutationAligned(pBase, m0);
                L0 = PermuteVar8x32(L0, perm);
                var pc = (ulong) (uint) MoveMask(perm.AsSingle());
                var pc2 = (8-PopCount(m0)) << 2;
                Store(writeLeft,  L0);
                Store(writeRight, L0);
                writeLeft = (int*) ((byte*) writeLeft + pc);
                writeRight = (int*) ((byte*) writeRight + pc - 32U);
            }
#endif
            static void PartitionBlock1V(Vector256<int> L0, Vector256<int> P, byte* pBase, ref int* writeLeft, ref int* writeRight)
            {
                ...
                var m0 = (ulong) (uint) MoveMask(CompareGreaterThan(L0, P).AsSingle());
                var perm = BytePermTables.GetSignedBytePermutationAligned(pBase, m0);
                L0 = PermuteVar8x32(L0, perm);
                ...
                //var pc = PopCount(m0) << 2;
                var rpc = perm.AsInt64().GetElement(0) >> 36;
                Store(writeLeft,  L0);
                Store(writeRight, L0);
                writeLeft  = writeLeft + rpc + 8;
                writeRight = writeRight + rpc;
            }
